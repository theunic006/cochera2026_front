...
// ✅ NUEVO: Imports actualizados para arquitectura de features
...
const ToleranceList = () => {
  ...
  // ✅ OPTIMIZACIÓN: useCallback - Carga de tolerancias
  const loadTolerances = useCallback(async (page = 1, pageSize = 15) => {
    setLoading(true);
    try {
  ...
  // ✅ OPTIMIZACIÓN: useCallback - Crear tolerancia
  const handleCreate = useCallback(() => {
    setEditingTolerance(null);
    setFormVisible(true);
  }, []);

  // ✅ OPTIMIZACIÓN: useCallback - Editar tolerancia
  const handleEdit = useCallback((tolerance) => {
    setEditingTolerance(tolerance);
    setFormVisible(true);
  }, []);

  // ✅ OPTIMIZACIÓN: useCallback - Eliminar tolerancia
  ...
  // ✅ OPTIMIZACIÓN: useCallback - Función de filtrado personalizado para múltiples campos
