...
const CompanyForm = ({ visible, onCancel, onSuccess, editingCompany = null }) => {
  ...
  // ✅ OPTIMIZACIÓN: useCallback - Manejo de cambio de logo
  ...
  // ✅ OPTIMIZACIÓN: useCallback - Función para manejar el envío del formulario
  ...
  }, [logoFile, isEditing, editingCompany, form, onSuccess]);

  // ✅ OPTIMIZACIÓN: useCallback - Función para manejar la cancelación
