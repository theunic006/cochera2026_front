...
const EditarForm = ({
  ...
  // ✅ OPTIMIZACIÓN: useCallback - Click en observación
  const handleObsClick = useCallback((descripcion) => {
    form.setFieldsValue({ observaciones: descripcion });
  }, [form]);

  // ✅ OPTIMIZACIÓN: useCallback - Imprimir ticket usando el endpoint local vía ngrok
  ...
  // ✅ OPTIMIZACIÓN: useCallback - Finalización del formulario
