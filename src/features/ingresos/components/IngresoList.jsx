...
import { vehiculoService } from '../../vehiculos/services/vehiculoService';
import AppLayout from '../../../components/AppLayout';
import EditarForm from './EditarForm';
import TerminarModal from './TerminarModal';
import { vehicleTypeService } from '../../vehicleTypes/services/vehicleTypeService';
...
// ✅ OPTIMIZACIÓN: Importar hooks personalizados
import { useDebounce } from '../../../hooks/useDebounce';
// ✅ OPTIMIZACIÓN: Importar componentes memoizados
import {
  PlacaCell,
  HoraIngresoCell,
  TiempoEstadiaCell,
...
const IngresoList = () => {
  ...
  // ✅ OPTIMIZACIÓN: Usar debouncedSearchText para evitar requests innecesarios
  useEffect(() => {
    cargarIngresos(1, 15, debouncedSearchText);
  }, [cargarIngresos, debouncedSearchText]);
  ...
  const handleRegistrarIngreso = useCallback(async () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setNuevaPlaca("");
        // ✅ OPTIMIZACIÓN: Usar debouncedSearchText
        cargarIngresos(1, 15, debouncedSearchText);
      } else {
  ...
  }, [nuevaPlaca, cleanPlacaForSubmit, cargarIngresos, debouncedSearchText]);

  const handleTableChange = useCallback((newPagination) => {
    // Solo permitir paginación cuando NO hay búsqueda activa
    // ✅ OPTIMIZACIÓN: Usar debouncedSearchText para evitar conflictos
  ...
  const handleReload = useCallback(() => {
    cargarIngresos(pagination.current, pagination.pageSize, debouncedSearchText);
  }, [cargarIngresos, pagination.current, pagination.pageSize, debouncedSearchText]);
    ...
    <AppLayout>
      ...
      <div>
        ...
        <TableBase
          ...
          dataSource={ingresos}
          loading={loading}
          // ✅ OPTIMIZACIÓN: Deshabilitar paginación durante búsqueda debounced
          pagination={debouncedSearchText.trim() ? false : pagination}
          ...
          showSearch={true}
          // ✅ searchText para el input (respuesta inmediata)
