import { useState, useEffect, useCallback } from 'react'; // ✅ OPTIMIZACIÓN: Agregar useCallback
import { 
  Modal, 
  Form, 
  Input, 
...
const UserForm = ({ visible, onCancel, onSuccess, editingUser = null, isProfileEdit = false, currentUser = null, isDark = false, passwordOnly = false }) => {
  ...
  /**
   * ✅ OPTIMIZACIÓN: useCallback - Manejar envío del formulario
   */
  ...
  }, [isEditing, isProfileEdit, passwordOnly, showPasswordFields, form, userToEdit, editingUser, userInfo, onSuccess]); // ✅ OPTIMIZACIÓN: Dependencias del useCallback

  /**
   * ✅ OPTIMIZACIÓN: useCallback - Validar confirmación de contraseña
   */
  const validatePasswordConfirmation = useCallback(({ getFieldValue }) => ({
    validator(_, value) {
  ...
  }), []); // ✅ OPTIMIZACIÓN: Sin dependencias

  /**
   * ✅ OPTIMIZACIÓN: useCallback - Manejar cancelación
   */
