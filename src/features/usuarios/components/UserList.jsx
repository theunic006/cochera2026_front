...
const UserList = () => {
  ...
  /**
   * ✅ OPTIMIZACIÓN: useCallback - Cargar usuarios desde la API
   */
  ...
  /**
   * ✅ OPTIMIZACIÓN: useCallback - Abrir modal para crear usuario
   */
  ...
  /**
   * ✅ OPTIMIZACIÓN: useCallback - Abrir modal para editar usuario
   */
  ...
  /**
   * ✅ OPTIMIZACIÓN: useCallback - Eliminar usuario
   */
  ...
  /**
   * ✅ OPTIMIZACIÓN: useCallback - Abrir modal de permisos
   */
  ...
  ], [pagination.current, pagination.pageSize, handleOpenPermissions, handleEditUser, handleDeleteUser]); // ✅ OPTIMIZACIÓN: Dependencias del useMemo
