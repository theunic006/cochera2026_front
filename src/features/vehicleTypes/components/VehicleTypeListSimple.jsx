...
const VehicleTypeListSimple = () => {
  ...
  // ✅ OPTIMIZACIÓN: useCallback - Carga de tipos de vehículo
  const loadVehicleTypes = useCallback(async (page = 1, perPage = 15) => {
    setLoading(true);
    try {
  ...
  // ✅ OPTIMIZACIÓN: useCallback - Crear tipo de vehículo
  const handleCreate = useCallback(() => {
    setEditingVehicleType(null);
    setFormVisible(true);
  }, []);

  // ✅ OPTIMIZACIÓN: useCallback - Editar tipo de vehículo
  const handleEdit = useCallback((vehicleType) => {
    setEditingVehicleType(vehicleType);
    setFormVisible(true);
  }, []);

  // ✅ OPTIMIZACIÓN: useCallback - Eliminar tipo de vehículo
